...
var OBJDoc = function(fileName) {
  ...
  this.textures = new Array(0);   // Initialize the property textureCoordinates /////
}
...
OBJDoc.prototype.parse = function(fileString, scale, reverse) {
  ...
  while ((line = lines[index++]) != null) {
    ...
    case 'vt':   // Read texture coordinates /////////
      var textureCoord = this.parseTexture(sp);
      this.textures.push(textureCoord); 
      continue; // Go to the next line
...
OBJDoc.prototype.getDrawingInfo = function() {
  // Create an arrays for vertex coordinates, normals, colors, textures, and indices /////
  var numIndices = 0;
  ...
  return new DrawingInfo(vertices, normals, colors, textures, indices); ////
}
...
// DrawInfo Object
//------------------------------------------------------------------------------
var DrawingInfo = function(vertices, normals, colors, textures, indices) { ////////
